            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input type="date" className="w-full border rounded-md px-3 py-2" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} min={minDate} />
                </div>
                <div>
              ...
              <Button disabled={!selectedDate || !selectedSlot} className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700" onClick={() => {
                if (selectedDate < minDate) {
                  toast.error('Please select a valid date (at least 2 days from today)');
                  return;
                }
